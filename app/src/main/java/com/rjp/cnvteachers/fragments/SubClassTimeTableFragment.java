...
public class SubClassTimeTableFragment extends Fragment {
    ...
    private ArrayList<ClassTimetableBean> arr = new ArrayList<ClassTimetableBean>();
    private ClassTimeTableAdapter adapt = null;

    public SubClassTimeTableFragment()
    {
    }

    @SuppressLint("ValidFragment")
    public SubClassTimeTableFragment(ClassTimeTableAdapter adapt)
    {
        this.adapt = adapt;
    }
